...
### Phase 5b: Resend and the confirmation email (planned)

- [ ] Resend integration with bounce and complaint handling.
- [ ] React Email confirmation template (branded, noClu voice), rendered and sent.
